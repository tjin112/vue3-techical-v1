<template>
  <div
    ...
    :class="upVote.state ? 'upvote-icon-light' : 'upvote-icon-dark'"
    id="child"
    @click="updateUpvote"
  >
    <svg
    ...
    >
      <path
        ...
        :fill="upVote.state ? '#253CF2' : '#343A40'"
      />
    </svg>
  </div>
</template>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    let upVote = store.getters["upvote/getState"];
    return {
      ...mapMutations("upvote", ["updateUpvote"]),
      store,
      upVote,
    };
  },
